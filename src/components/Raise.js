    ...
    <div className="px-10 my-32  w-full relative">
      ...
      <div className="container mx-auto flex flex-wrap justify-center items-center">
        <div className="w-full md:w-1/3 flex flex-col justify-between h-full">
          <p className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-normal">
            Looking to raise capital for your growing business?
          </p>
          <p className="text-lg sm:text-xl lg:text-2xl font-normal text-[#999] leading-9 text-justify my-8">
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <img src={charImg} className="z-10 mt-10 md:mt-0" />
        </div>
      </div>
    </div>
  );
